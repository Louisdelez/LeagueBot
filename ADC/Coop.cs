...
namespace LeagueBot
{
    public class Coop : PatternScript
    {
        ...
        {
            new Item("Doran Blade",450),
            new Item("Noonquiver",1300),
            new Item("Kraken Slayer",2100),
            new Item("Berserker Greaves",1100), // <--- Cost when Lost Chapter & Blasting Wand were bought
            new Item("Runaan Hurricane",2600),
            new Item("Guinsoo Rageblade",2600),
            new Item("Bloodthirster",3400),
        };
